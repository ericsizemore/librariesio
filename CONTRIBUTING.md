...
These contributions can be made in the form of Issues or [Pull Requests](http://help.github.com/send-pull-requests/) on the [library's repository](https://github.com/ericsizemore/librariesio).

Here are some examples how you can contribute:

* [Report a bug](https://github.com/ericsizemore/librariesio/issues/new?labels=bug,unverified&template=1-bug_report.yml)
* [Propose a new feature](https://github.com/ericsizemore/librariesio/issues/new?labels=enhancement,unverified&template=2-feature_request.yml)
* [Send a pull request](https://github.com/ericsizemore/librariesio/pulls)
...
[Backwards compatibility](https://github.com/ericsizemore/librariesio/blob/master/backward-compatibility.md) breaks in this project are being kept to an absolute minimum. Please take this into account when proposing changes.
...
```bash
$ git clone https://github.com/ericsizemore/librariesio.git
$ cd librariesio
```
